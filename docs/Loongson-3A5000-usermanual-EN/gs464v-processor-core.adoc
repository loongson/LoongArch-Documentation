...
GS464V is a quad-launch 64-bit high-performance processor core.
...
The multiple GS464V cores in the Loongson 3A5000 form a distributed multi-core architecture with a shared on-chip last-level Cache through the AXI interconnect network.
The main features of GS464V are as follows:
...
The structure of GS464V is shown in the following figure.

[[gs464v-structure]]
.GS464V structure
image::gs464v-structure.png[]

include::gs464v-processor-core/instruction-set-features-implemented-in-3a5000.adoc[]

include::gs464v-processor-core/access-to-3a5000-control-and-status-registers.adoc[]
