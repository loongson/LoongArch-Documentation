...
** https://github.com/loongson/LoongArch-Documentation/releases/latest/download/LoongArch-Vol1-v1.10-CN.pdf[原始文档] 。
...
* 龙芯架构指令格式约定：该文档面向需要处理 LoongArch 机器语言的项目、开发者，介绍了龙芯架构指令格式、操作数槽的统一命名约定。
** link:LoongArch-instruction-format-conventions-CN.html[HTML 版本]。
** link:LoongArch-instruction-format-conventions-CN.pdf[PDF 版本]。
