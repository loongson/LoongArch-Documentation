...
设置64位符号值31:12位到指令中,带20位有符号数溢出检测功能
...
设置64位符号值11:0位到指令中, 带12位无符号数溢出检测功能
...
设置64位符号值51:32位到指令中,带20位有符号数溢出检测功能
...
设置64位符号值最高12位到指令中,带12位有符号数溢出检测功能
...
设置32位相对PC值高20位到指令中,带20位有符号数溢出检测功能
...
设置38位相对PC值高20位到指令中,带20位有符号数溢出检测功能
...
设置64位相对PC值31:12位到指令中,带20位有符号数溢出检测功能
...
设置64位相对PC值11:0位到指令中, 带12位无符号数溢出检测功能
...
设置32位相对PC值11:0位到指令中, 带12位有符号数溢出检测功能
...
设置64位相对PC值51:32位到指令中, 带20位有符号数溢出检测功能
...
设置64位相对PC值63:52位到指令中,带12位有符号数溢出检测功能
...
设置32位GOT项相对PC值31:12位到指令中, 带20位有符号数溢出检测功能
...
设置64位GOT项相对PC值31:12位到指令中, 带20位有符号数溢出检测功能
...
设置32位 TLS.IE GOT相对PC值高20位到指令中,带20位有符号数溢出检测功能
...
设置64位 TLS.IE GOT相对PC值31:12位到指令中,带20位有符号数溢出检测功能
...
设置64位符号相对tp值31:12位到指令中,带20位有符号数溢出检测功能
...
设置64位符号相对tp值11:0位到指令中,带12位无符号数溢出检测功能
...
设置64位符号相对tp值51:32位到指令中,带20位有符号数溢出检测功能
...
设置64位符号相对tp值63:52位到指令中,带12位有符号数溢出检测功能
...
设置32位 TLS.GD GOT相对PC值高20位到指令中,带20位有符号数溢出检测功能
...
设置64位 TLS.GD GOT相对PC值31:12位到指令中,带20位有符号数溢出检测功能
...
设置38位相对PC值低17:2位到指令中,带16位有符号数溢出检测功能
|===
